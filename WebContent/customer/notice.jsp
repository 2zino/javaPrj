<%@page import="net.answeris.web.model.Notice"%>
			...
			<div id="content">
				...
				<form id="content-searchform" class="article-search-form"
					...
					<fieldset>
						...
						</select> <label class="hidden" for="q">검색어</label> 
					...
					<tbody>
						<c:forEach var="n" items="${list}">
							...
							<tr>
								...
								<td class="title"><a href="notice-detail?c=${n.code}">${n.title}</a> [<span style="color:red"> ${n.cmtCnt} </span>]</td>									
				...
				<p class="article-comment margin-small">
					<a class="btn-write button" href="notice-reg.jsp">글쓰기</a>
				</p>
				...
				<div id="pager-wrapper" class="margin-small">
					<div class="pager clear">
						...
						<ul>
							<li><a class="strong" href="notice?f=${param.f}&q=${param.q}&pg=1">1</a></li>
							<li><a href="notice?f=${param.f}&q=${param.q}&pg=2">2</a></li>
							<li><a href="notice?f=${param.f}&q=${param.q}&pg=3">3</a></li>
							<li><a href="notice?f=${param.f}&q=${param.q}&pg=4">4</a></li>
							<li><a href="notice?f=${param.f}&q=${param.q}&pg=5">5</a></li>
						</ul>
						<p id="btnNext">
