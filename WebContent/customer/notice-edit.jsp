				...
				<form action="notice-edit" method="post">
					<div id="notice-article-detail" class="article-detail margin-large">
						...
						<div class="article-content">
							<textarea id="txtContent" class="txtContent" name="content"><%=request.getAttribute("content")%></textarea>
						</div>
					</div>

					<p class="article-comment margin-small">
						<input type="submit" class="btn-save button" value="수정" /> <input
							type="hidden" name="code" value="<%=request.getAttribute("code")%>" /> <a
							class="btn-cancel button" href="notice-detail.jsp?c=<%=request.getAttribute("code")%>">취소</a>
					</p>
				</form>
			</div>
